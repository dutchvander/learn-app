...
import { useLoadUserQuery } from "@/feutures/api/authApi";
...
const Profile = () => {
  ...
  return <div className="max-w-4xl mx-auto px-4 my-10">
        ...
        <Dialog>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Make changes to your profile , Click save when you will done .</DialogDescription>
            </DialogHeader>
              ...
              <Button disabled={isLoading}>
                {
                  isLoading ? (
                    <>
                    <Loader2 className="mr-2 h-4 w-4 animate-spin "/> Please wait a moment 
                    </>
                  ): "Save Changes"
                }
              </Button>
    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 my-5">
        {
          user.enrollledCourses.length === 0 ? <h1>You havn't enrolled yet </h1> : (
